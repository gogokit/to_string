...
func TestToString(t *testing.T) {
	Convey("TestToString", t, func() {
		...
		Convey("test_NoBaseKindsInfoOnly", func() {
			const loopCnt = 1000
			const expectStr = `(to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)$Obj3(0-2), StructSlice2:([]to_string.CommonStruct)$Obj3(1-2), StructSlice3:([]to_string.CommonStruct)[], IntPtr:(***int)1, SlicePtr:(*[]int)<Obj4>$Obj1(0-9)}, {<Obj1>:([]int)[1(0), 2, 3(2), 4, 5(4), 6, 7, 8, 9, 10(9)], <Obj2>:([]uint8)[116(0), 104, 105, 115, 32, 105, 115, 32, 98, 121, 116, 101, 32, 115, 108, 105, 99, 101, 33(18)], <Obj3>:([]to_string.CommonStruct)[(to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)nil, StructSlice2:([]to_string.CommonStruct)nil, StructSlice3:([]to_string.CommonStruct)nil, IntPtr:(***int)1, SlicePtr:(*[]int)$Obj4}(0), (to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)nil, StructSlice2:([]to_string.CommonStruct)nil, StructSlice3:([]to_string.CommonStruct)nil, IntPtr:(***int)1, SlicePtr:(*[]int)$Obj4}(1), (to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)nil, StructSlice2:([]to_string.CommonStruct)nil, StructSlice3:([]to_string.CommonStruct)nil, IntPtr:(***int)1, SlicePtr:(*[]int)$Obj4}(2)]}`
			for i := 1; i <= loopCnt; i++ {
		...
		Convey("test_AllTypesInfo", func() {
			const loopCnt = 1000
			const expectStr = `(to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)$Obj3(0-2), StructSlice2:([]to_string.CommonStruct)$Obj3(1-2), StructSlice3:([]to_string.CommonStruct)[], IntPtr:(***int)1, SlicePtr:(*[]int)<Obj4>$Obj1(0-9)}, {<Obj1>:([]int)[(int)1(0), (int)2, (int)3(2), (int)4, (int)5(4), (int)6, (int)7, (int)8, (int)9, (int)10(9)], <Obj2>:([]uint8)[(uint8)116(0), (uint8)104, (uint8)105, (uint8)115, (uint8)32, (uint8)105, (uint8)115, (uint8)32, (uint8)98, (uint8)121, (uint8)116, (uint8)101, (uint8)32, (uint8)115, (uint8)108, (uint8)105, (uint8)99, (uint8)101, (uint8)33(18)], <Obj3>:([]to_string.CommonStruct)[(to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)nil, StructSlice2:([]to_string.CommonStruct)nil, StructSlice3:([]to_string.CommonStruct)nil, IntPtr:(***int)1, SlicePtr:(*[]int)$Obj4}(0), (to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)nil, StructSlice2:([]to_string.CommonStruct)nil, StructSlice3:([]to_string.CommonStruct)nil, IntPtr:(***int)1, SlicePtr:(*[]int)$Obj4}(1), (to_string.CommonStruct){IntSlice1:([]int)$Obj1(0-9), IntSlice2:([]int)nil, IntSlice3:([]int)$Obj1(2-4), ByteSlice:([]uint8)$Obj2(0-18), StructSlice1:([]to_string.CommonStruct)nil, StructSlice2:([]to_string.CommonStruct)nil, StructSlice3:([]to_string.CommonStruct)nil, IntPtr:(***int)1, SlicePtr:(*[]int)$Obj4}(2)]}`
			for i := 1; i <= loopCnt; i++ {
				So(StringByConf(cs, Config{
		...
		Convey("test_filte_all_slice", func() {
			const loopCnt = 1000
		...
		Convey("test_show_byte_slice_by_string", func() {
			const loopCnt = 1000
		...
		Convey("test_IntroductionRecursion", func() {
			...
			const loopCnt = 1000
			expectStr := `([]to_string.MyStruct)$Obj1(0-0), {<Obj1>:([]to_string.MyStruct)[(to_string.MyStruct){S:([]to_string.MyStruct)$Obj1(0-0), Str:(string)"结构体字段Str"}(0)]}`
